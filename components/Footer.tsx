          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-6 h-6 border border-[#C9A84C] rotate-45 flex items-center justify-center shrink-0">
                <span className="text-[#C9A84C] font-serif text-[8px] font-bold -rotate-45">RPM</span>
              </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/40 text-sm font-sans leading-relaxed">
                  425 Park Avenue<br />Detroit, MI 48234
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={14} className="text-[#C9A84C] shrink-0" />
                <a href="tel:+13130000000" className="text-white/40 hover:text-[#C9A84C] text-sm font-sans transition-colors duration-300">
                  +1 (313) 000-0000
                </a>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={14} className="text-[#C9A84C] shrink-0" />
                <a href="mailto:hello@RPMmotors.com" className="text-white/40 hover:text-[#C9A84C] text-sm font-sans transition-colors duration-300">
                  hello@RPMmotors.com
                </a>
              </li>
            </ul>
