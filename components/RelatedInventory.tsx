        ...
        return (
          <div
            ...
            className="rounded-2xl bg-[#0d1526] border border-white/[0.07] overflow-hidden
              hover:border-[#FF5500]/30 hover:-translate-y-0.5 transition-all duration-200"
          >
            {/* Image / placeholder */}
            <div className={`relative aspect-[16/10] ${hasImage ? '' : `bg-gradient-to-br ${gradient}`}`}>
              ...
              {/* Make badge */}
              <div className="absolute top-2.5 left-2.5 px-2 py-[3px] bg-[#FF5500] text-black text-[8px] font-black uppercase rounded shadow-sm">
                {car.make}
              </div>
            </div>
            ...
            <div className="px-4 py-4">
              <p className="text-[9px] font-black uppercase tracking-[3px] text-[#FF5500] mb-0.5">
                {car.year} · {car.make}
              </p>
              ...
              <Link
                ...
                className="flex items-center justify-center gap-1.5 w-full py-2.5 rounded-xl
                  ...
                  hover:bg-[#FF5500] hover:border-[#FF5500] hover:text-black
